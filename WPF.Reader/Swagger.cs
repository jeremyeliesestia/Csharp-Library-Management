...
namespace WPF.Reader.Api
{
    ...
    public interface IBookApiSync : IApiAccessor
    {
        ...
        /// <param name="numeroLivre"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Book</returns>
        Book BookGetBook(int? numeroLivre = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<Book> BookGetBookWithHttpInfo(int? numeroLivre = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="WPF.Reader.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// </summary>
        /// <exception cref="WPF.Reader.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="numeroGenre"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Genre</returns>
        Genre BookGetGenre(int? numeroGenre = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<Genre> BookGetGenreWithHttpInfo(int? numeroGenre = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="WPF.Reader.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IBookApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Book> BookGetBookAsync(int? numeroLivre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<Book>> BookGetBookWithHttpInfoAsync(int? numeroLivre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Genre> BookGetGenreAsync(int? numeroGenre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<Genre>> BookGetGenreWithHttpInfoAsync(int? numeroGenre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class BookApi : IBookApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Book</returns>
        public Book BookGetBook(int? numeroLivre = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.ApiResponse<Book> localVarResponse = BookGetBookWithHttpInfo(numeroLivre);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Book</returns>
        public WPF.Reader.Client.ApiResponse<Book> BookGetBookWithHttpInfo(int? numeroLivre = default(int?), int operationIndex = 0)
        {
            ...
            if (numeroLivre != null)
            {
                localVarRequestOptions.QueryParameters.Add(WPF.Reader.Client.ClientUtils.ParameterToMultiMap("", "numero_livre", numeroLivre));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Book</returns>
        public async System.Threading.Tasks.Task<Book> BookGetBookAsync(int? numeroLivre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.ApiResponse<Book> localVarResponse = await BookGetBookWithHttpInfoAsync(numeroLivre, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Book)</returns>
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<Book>> BookGetBookWithHttpInfoAsync(int? numeroLivre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Genre</returns>
        public Genre BookGetGenre(int? numeroGenre = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.ApiResponse<Genre> localVarResponse = BookGetGenreWithHttpInfo(numeroGenre);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Genre</returns>
        public WPF.Reader.Client.ApiResponse<Genre> BookGetGenreWithHttpInfo(int? numeroGenre = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            if (numeroGenre != null)
            {
                localVarRequestOptions.QueryParameters.Add(WPF.Reader.Client.ClientUtils.ParameterToMultiMap("", "numero_genre", numeroGenre));
            }
            localVarRequestOptions.Operation = "BookApi.BookGetGenre";
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = this.Client.Get<Genre>("/api/Book/GetGenre", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BookGetGenre", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Genre</returns>
        public async System.Threading.Tasks.Task<Genre> BookGetGenreAsync(int? numeroGenre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.ApiResponse<Genre> localVarResponse = await BookGetGenreWithHttpInfoAsync(numeroGenre, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Genre)</returns>
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<Genre>> BookGetGenreWithHttpInfoAsync(int? numeroGenre = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Genre>("/api/Book/GetGenre", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BookGetGenre", localVarResponse);
                if (_exception != null)
...
namespace WPF.Reader.Model
{
    ...
    public partial class Book : IEquatable<Book>, IValidatableObject
    {
        ...
        public Book(int id = default(int), string nom = default(string), string authors = default(string), double prix = default(double), string contenu = default(string), List<Genre> genre = default(List<Genre>))
        {
            this.Id = id;
            this.Prix = prix;
            this.Nom = nom;
...
namespace WPF.Reader.Model
{
    ...
    public partial class Genre : IEquatable<Genre>, IValidatableObject
    {
        ...
        /// <param name="id">id (required).</param>
        /// <param name="nom">nom.</param>
        public Genre(int id = default(int), string nom = default(string))
        {
            this.Id = id;
            this.Nom = nom;
        }
